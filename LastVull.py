#!/usr/bin/python
#-*- coding:utf-8 -*-  
import os , urllib, re, argparse, sys
os.system("clear")
def pesquisa(link):
...
parser.add_argument("--WordPress", help="To verify that the new vulnerabilities for WordPress", action="store_true")
parser.add_argument("--Joomla", help="To verify that the new vulnerabilities for Joomla", action="store_true" )
