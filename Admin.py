...
def Argumentos():
	...
	parse.add_argument("-S", action="store", dest="S", required=True, help="Use -s para definir o site.")
	parse.add_argument("-W", action="store", dest="W", required=True, help="Use -W para passar o caminho da WordList.")
